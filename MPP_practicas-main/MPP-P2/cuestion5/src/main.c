...
int main(int argc, char **argv)
{
    ...
    int n = 0, m = 0, n_gen = 0, tam_pob = 0, nem = 0, ngm = 0; // Inicializamos a 0 para evitar el warning
    double m_rate;
    ...
    MPI_Bcast(params_int, num_int_params, MPI_INT, 0, MPI_COMM_WORLD);
    ...
    // Distribución de la matriz d
    MPI_Bcast(d, tam_d, MPI_DOUBLE, 0, MPI_COMM_WORLD);
