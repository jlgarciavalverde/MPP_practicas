...
plot_metric(
    ...
    title="np=2: Tiempo medio vs configuración (NEM,NGM)",
    filename="tiempo_vs_np2.png"
)

plot_metric(
    distancias,
    ylabel="Fitness medio (distance_media)",
    title="np=2: Fitness medio vs configuración (NEM,NGM)",
    filename="distance_vs_np2.png"
)

plot_metric(
    eficiencia,
    ylabel="Índice de eficiencia I = fitness/tiempo",
    title="np=2: Eficiencia I vs configuración (NEM,NGM)",
    filename="eficiencia_vs_np2.png"
)
